            ...
            <header className="header">
                ...
                <Fade right>
                    ...
                    <button className="resume" target="_blank" rel="noopener noreferrer">
                      <li> <a className="res" href="https://drive.google.com/file/d/1EkX_-SUKSELhYzpZvCiOM3mvNVlr_Oic/view?usp=sharing" target="_blank" rel="noopener noreferrer"> Resume</a> </li>
                    </button>
                </Fade>            
                </ul>
            </header>
