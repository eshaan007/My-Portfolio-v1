            ...
            <header className="header">
                ...
                <Fade right>
                    ...
                    <button className="resume" target="_blank" rel="noopener noreferrer">
                      <li> <a className="res" href="https://drive.google.com/file/d/1vSmtN4mST7a5taAxAtUW-3_hUdjykouy/view?usp=sharing" target="_blank" rel="noopener noreferrer"> Resume</a> </li>
                    </button>
                </Fade>            
                </ul>
            </header>
