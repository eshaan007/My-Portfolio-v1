            ...
            <header className="header">
                ...
                <Fade right>
                    ...
                    <button className="resume" target="_blank" rel="noopener noreferrer">
                      <li> <a className="res" href="https://drive.google.com/file/d/1I7h8Tx9O-jewYRwNbDlkZbm18zeE9h2_/view?usp=sharing" target="_blank" rel="noopener noreferrer"> Resume</a> </li>
                    </button>
                </Fade>            
                </ul>
            </header>
