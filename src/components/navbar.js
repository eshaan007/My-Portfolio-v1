            ...
            <header className="header">
                ...
                <Fade right>
                    ...
                    <button className="resume" target="_blank" rel="noopener noreferrer">
                      <li> <a className="res" href="https://drive.google.com/file/d/1qzHoBJO5lJvJewdrrTyOA3Om2Mr4ukbh/view?usp=drivesdk" target="_blank" rel="noopener noreferrer"> Resume</a> </li>
                    </button>
                </Fade>            
                </ul>
            </header>
