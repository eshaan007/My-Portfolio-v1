                        ...
                        <div className="about-cert">
                            ...
                            <Column className="col2" flexGrow={1}>
                                <Row wrap horizontal='spaced'>
                                    ...
                                    <Column className="card" flexGrow={1} horizontal='spaced'>
                                        <a className="cert-name-google1" href="https://learndigital.withgoogle.com/digitalunlocked/validate-certificate-code" target="_blank" rel="noopener noreferrer">The Fundamentals of Digital Marketing</a>
